...
public final class DatabaseModule_ProvideDatabaseFactory implements Factory<SelfProtocolDatabase> {
  ...
  @Override
  public SelfProtocolDatabase get() {
  ...
  public static SelfProtocolDatabase provideDatabase(Context context) {
